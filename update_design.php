...
$id= $_GET['id'];
$query="SELECT * FROM tableform where id='$id'" ;
...
<html>
    ...
    <body>
        <div class="container">
            ...
            <div class="input_field">
                <label>Comment</label>
                <textarea name="comment"><?php echo $result['comment']; ?></textarea>
            </div>
...
<?php
   if($_POST['update'])
   {
      ...
      $query= "UPDATE tableform set fname='$fname',lname='$lname',email='$email',password='$password',conpassword='$conpassword',gender='$gender',address='$address',comment='$comment' WHERE id='$id'";
      $data= mysqli_query($conn,$query);
